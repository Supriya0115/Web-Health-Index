...
function displayCounties() {
    ...
    var html = '<div class="col-md-12 preferenceHeader">';
    html += '<div class="col-md-1">StateName</div>';
    html += '<div class="col-md-1">CountyName</div>';
    html += '<div class="col-md-2">AggregatedValue</div>';
    ...
    html += '<div class="col-md-3">CountyWikiLink</div>';
    html += '</div>';

    html += '<div class="col-md-12 countyData">';
    html += '<div class="col-md-1  countyData">' + response[0].StateName + '</div>';
    html += '<div class="col-md-1  countyData">' + response[0].CountyName + '</div>';
    html += '<div class="col-md-2  countyData">' + response[0].AggregatedValue + '</div>' ;
    html += '<div class="col-md-1  countyData">' + response[0].Population + '</div>';
    html += '<div class="col-md-1  countyData">' + response[0].TotalArea + '</div>';
    html += '<div class="col-md-1  countyData">' + response[0].Latitude + '</div>';
    html += '<div class="col-md-1  countyData">' + response[0].Longitude + '</div>';
    html += '<div class="col-md-3 countyData"> <div class="countyData"> <a href="' + response[0].CountyWikiLink + '">' + response[0].CountyName +'</div>' +' </div>';
    html += '</div>';

    html += '<div class="col-md-12 countyData">';
    html += '<div class="col-md-1  countyData">' + response[1].StateName + '</div>';
    html += '<div class="col-md-1  countyData">' + response[1].CountyName + '</div>';
    html += '<div class="col-md-2  countyData">' + response[1].AggregatedValue + '</div>' ;
    html += '<div class="col-md-1  countyData">' + response[1].Population + '</div>';
    html += '<div class="col-md-1  countyData">' + response[1].TotalArea + '</div>';
    html += '<div class="col-md-1  countyData">' + response[1].Latitude + '</div>';
    html += '<div class="col-md-1  countyData">' + response[1].Longitude + '</div>';
    html += '<div class="col-md-3 countyData"> <a href="' + response[1].CountyWikiLink + '">' + response[1].CountyName  +' </div>';
    html += '</div>';

    html += '<div class="col-md-12 countyData">';
    html += '<div class="col-md-1  countyData">' + response[2].StateName + '</div>';
    html += '<div class="col-md-1  countyData">' + response[2].CountyName + '</div>';
    html += '<div class="col-md-2  countyData">' + response[2].AggregatedValue + '</div>' ;
    html += '<div class="col-md-1  countyData">' + response[2].Population + '</div>';
    html += '<div class="col-md-1  countyData">' + response[2].TotalArea + '</div>';
    html += '<div class="col-md-1  countyData">' + response[2].Latitude + '</div>';
    html += '<div class="col-md-1  countyData">' + response[2].Longitude + '</div>';
    html += '<div class="col-md-3 countyData"> <a href="' + response[2].CountyWikiLink + '">' + response[2].CountyName  +' </div>';
    html += '</div>';
